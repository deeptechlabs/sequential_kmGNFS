...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/libgnfs_common_library.a

dist/Debug/libgnfs_common_library.a: ${OBJECTFILES}
	${MKDIR} -p dist/Debug
	${RM} dist/Debug/libgnfs_common_library.a
	${AR} rv dist/Debug/libgnfs_common_library.a ${OBJECTFILES} 
	$(RANLIB) dist/Debug/libgnfs_common_library.a

${OBJECTDIR}/Sieving.o: nbproject/Makefile-${CND_CONF}.mk Sieving.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/Sieving.o Sieving.cpp

${OBJECTDIR}/LineSieving.o: nbproject/Makefile-${CND_CONF}.mk LineSieving.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/LineSieving.o LineSieving.cpp

${OBJECTDIR}/gnfs_utils.o: nbproject/Makefile-${CND_CONF}.mk gnfs_utils.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/gnfs_utils.o gnfs_utils.cpp

${OBJECTDIR}/Relation.o: nbproject/Makefile-${CND_CONF}.mk Relation.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/Relation.o Relation.cpp

${OBJECTDIR}/pair_intType_intType.o: nbproject/Makefile-${CND_CONF}.mk pair_intType_intType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/pair_intType_intType.o pair_intType_intType.cpp

${OBJECTDIR}/triple_intType.o: nbproject/Makefile-${CND_CONF}.mk triple_intType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/triple_intType.o triple_intType.cpp

${OBJECTDIR}/FactorBases.o: nbproject/Makefile-${CND_CONF}.mk FactorBases.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/FactorBases.o FactorBases.cpp

${OBJECTDIR}/LinearAlgebra.o: nbproject/Makefile-${CND_CONF}.mk LinearAlgebra.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/LinearAlgebra.o LinearAlgebra.cpp

${OBJECTDIR}/SquareRoot.o: nbproject/Makefile-${CND_CONF}.mk SquareRoot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/SquareRoot.o SquareRoot.cpp

${OBJECTDIR}/pair_long_long.o: nbproject/Makefile-${CND_CONF}.mk pair_long_long.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/pair_long_long.o pair_long_long.cpp

${OBJECTDIR}/Parameters.o: nbproject/Makefile-${CND_CONF}.mk Parameters.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/Parameters.o Parameters.cpp

${OBJECTDIR}/PolynomialSelection.o: nbproject/Makefile-${CND_CONF}.mk PolynomialSelection.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/PolynomialSelection.o PolynomialSelection.cpp
...
${OBJECTDIR}/vec_intType.o: nbproject/Makefile-${CND_CONF}.mk vec_intType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/vec_intType.o vec_intType.cpp

${OBJECTDIR}/MatrixConstruction.o: nbproject/Makefile-${CND_CONF}.mk MatrixConstruction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/MatrixConstruction.o MatrixConstruction.cpp

${OBJECTDIR}/Initialization.o: nbproject/Makefile-${CND_CONF}.mk Initialization.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/Initialization.o Initialization.cpp

${OBJECTDIR}/pair_uintType_uintType.o: nbproject/Makefile-${CND_CONF}.mk pair_uintType_uintType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/pair_uintType_uintType.o pair_uintType_uintType.cpp

${OBJECTDIR}/vec_uintType.o: nbproject/Makefile-${CND_CONF}.mk vec_uintType.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Iinclude -MMD -MP -MF $@.d -o ${OBJECTDIR}/vec_uintType.o vec_uintType.cpp
