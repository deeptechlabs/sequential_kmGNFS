...
#ifndef _GNFS_PAIR_UINTTYPE_UINTTYPE_H
#define	_GNFS_PAIR_UINTTYPE_UINTTYPE_H
...
NTL_pair_decl(uint_type, uint_type, pair_uintType_uintType)
NTL_pair_io_decl(uint_type, uint_type, pair_uintType_uintType)
NTL_pair_eq_decl(uint_type, uint_type, pair_uintType_uintType)

NTL_vector_decl(pair_uintType_uintType, vec_pair_uintType_uintType)
NTL_io_vector_decl(pair_uintType_uintType, vec_pair_uintType_uintType)
NTL_eq_vector_decl(pair_uintType_uintType, vec_pair_uintType_uintType)


#endif	/* _GNFS_PAIR_UINTTYPE_UINTTYPE_H */
