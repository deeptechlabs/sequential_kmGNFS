...
#ifndef _GNFS_VEC_INTTYPE_H
#define	_GNFS_VEC_INTTYPE_H
...
NTL_vector_decl(int_type, vec_intType)

NTL_io_vector_decl(int_type, vec_intType)

NTL_eq_vector_decl(int_type, vec_intType)


#endif	/* _GNFS_VEC_INTTYPE_H */
