...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/gnfs_sieving

dist/Release/gnfs_sieving: ../GNFS_Common_Library/dist/Release/libgnfs_common_library.a

dist/Release/gnfs_sieving: ${OBJECTFILES}
	${MKDIR} -p dist/Release
	${LINK.cc} -o dist/Release/gnfs_sieving ${OBJECTFILES} ${LDLIBSOPTIONS} 
