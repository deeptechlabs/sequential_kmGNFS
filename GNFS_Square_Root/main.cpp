...
int main(int argc, char* argv[]) {
    ...
    cout << "*** Square root step started..." << endl;
    ...
    cout << "*** Initializing square root step..." << endl;
    if (!sqr.init(true)) {
        cout << "*** An error occured while initializing the square root step... Exiting..." << endl;
        return EXIT_FAILURE;
    }

    cout << "*** Executing the square root step..." << endl;
    if (!sqr.executeSquareRootStep()) {
        cout << "*** An error occured while executing the square root step... Exiting..." << endl;
        return EXIT_FAILURE;
    }
